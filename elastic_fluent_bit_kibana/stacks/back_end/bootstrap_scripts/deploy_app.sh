...
LOG_FILE="/var/log/miztiik-automation-boot-strap.log"
...
"logs": {
    ...
    "files": {
        ...
        {
            "file_path": "/var/log/miztiik-automation-boot-strap.log",
            "log_group_name": "/miztiik-automation/boot-strap",
            "timestamp_format": "%b %-d %H:%M:%S",
            "timezone": "Local"
        }
        ]
